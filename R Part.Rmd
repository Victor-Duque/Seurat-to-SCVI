...
setwd("C:/Users/victo/OneDrive/Doutorado e IC - Dados/Bioinformatica/SCVI")
set.seed(4301)
library(Seurat)
library(tidyverse)
```
...
write.csv(merged_obj@meta.data, file='Data_metadata.csv', quote=F, row.names=F)
library(Matrix)
counts_matrix <- JoinLayers(merged_obj)
counts_matrix = GetAssayData(counts_matrix, assay='RNA', slot='counts')
writeMM(counts_matrix, file= 'Data_counts.mtx')
```
